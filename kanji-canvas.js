(function (window, document) {
	...
	KanjiCanvas.erase = function (id) {
		...
		// Toggle the visibility of all .divTableCell elements to hide them
		var divTableCells = document.querySelectorAll('.divTableCell');
		divTableCells.forEach(function(cell) {
	...
	*/
	...
	KanjiCanvas.recognize = function (id) {
		...
		// Extract recognized kanji characters
		var recognizedKanji = KanjiCanvas.fineClassification(extractedFeatures, candidates);

		// Toggle visibility of recognized kanji characters
		var divTableCells = document.querySelectorAll('.divTableCell');
		divTableCells.forEach(function (cell) {
			var kanjiText = cell.querySelector('.kanji').textContent.trim();
			var isVisible = recognizedKanji.includes(kanjiText);
